class Firewall {
    ...
    init() {
        ...
        console.log('%cFirewall Active', 'color: #00ff00; font-weight: bold;');
    }
    ...
    logEvent(msg) {
        ...
        const formattedMsg = `[Firewall][${timestamp}] ${msg}`;
        ...
        if (!this.overrideConsole) {
            ...
            console.clear = function() {
                ...
                console.log(`%c[Firewall] Console cleared!`, 'color: #ff0000; font-weight: bold; background: #fff3f3;');
    ...
    startConsoleMonitor() {
        setInterval(() => {
            ...
            if (this.log.length) {
                ...
                console.log(`%c[Firewall][LIVE] ${last}`, 'color: #ff6600; font-weight: bold;');
            }
        }, 1000);
    }
    ...
    startSelfInflate() {
        setInterval(() => {
            if (!window.firewall || window.firewall.isCompromised) {
                console.warn('%cFirewall self-inflating...', 'color: #ff0000; font-weight: bold;');
